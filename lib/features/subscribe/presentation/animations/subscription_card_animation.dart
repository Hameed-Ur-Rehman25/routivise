...
class SubscriptionCardAnimation {
  ...
  static Animation<double> getScaleAnimation(AnimationController controller, bool isExpanded) {
    ...
    return TweenSequence<double>([
      ...
      TweenSequenceItem(
        tween: Tween<double>(
          begin: isExpanded ? config.expandedScale * 1.05 : config.collapsedScale, 
