...
class QuizScreenNo22 extends StatelessWidget {
  final int selected;
  final ValueChanged<int> onChanged;
  const QuizScreenNo22({super.key, required this.selected, required this.onChanged});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const Text(
          'Do you want to schedule deep focus sessions into your routine?',
