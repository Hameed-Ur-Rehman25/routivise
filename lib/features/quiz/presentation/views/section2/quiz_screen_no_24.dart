...
class QuizScreenNo24 extends StatelessWidget {
  final int selected;
  final ValueChanged<int> onChanged;
  const QuizScreenNo24({super.key, required this.selected, required this.onChanged});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const Text(
          'Do you want reminders for breaks/posture movement?',
